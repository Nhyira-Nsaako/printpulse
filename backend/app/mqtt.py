...
# to your deployed frontend URL(s), e.g. https://printpulse.vercel.app
...
MQTT_PORT=1883
MQTT_TOPIC_VIBRATION=printpulse/live
MQTT_TOPIC_TEMPERATURE=printpulse/printer
MQTT_TOPIC_STATUS=printpulse/status
MQTT_USERNAME=
MQTT_PASSWORD=
...
# Fault classes that trigger alerts (comma-separated) — must match the
# FaultClass enum values (NORMAL, MECHANICAL_FAULT, THERMAL_ANOMALY)
ALERT_FAULT_CLASSES=MECHANICAL_FAULT,THERMAL_ANOMALY
